...
using UIAMS.OConnect.Infrastructure;
...
{
    internal class OpenConnectAuthenticationHandler : AuthenticationHandler<OpenConnectAuthenticationOptions>
    {
        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public OpenConnectAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                if (messageValidated)
                {
                    ...
                    var context = new OpenConnectAuthenticatedContext(
                        Context,
                        identity,
                        properties,
                        responseMessage,
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new OpenConnectApplyRedirectContext(
                    Context, Options,
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new OpenConnectReturnEndpointContext(Context, model);
