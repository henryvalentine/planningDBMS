...
namespace DPR_DataMigrationEngine.BulkUploadManagerManager
{
    ...
    public class WellUploadManager
    {
        public bool Import(string filePath, string sheetName, ref List<Well> mList, ref string msg)
        {
            ...
            var selectString = @"SELECT [Well_Name],[WellType_Name],[WellClass_Name],[Total_Dept],[Technical_Allowed], [SPud_Date], [Remarks] FROM [" + sheetName + "$]";
